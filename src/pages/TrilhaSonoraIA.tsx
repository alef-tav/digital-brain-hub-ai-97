...
const TrilhaSonoraIA = () => {
  const category = categoriesData.find(cat => cat.title === "Trilha Sonora por IA");
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-400 max-w-4xl mx-auto leading-relaxed">
              Criação de trilhas sonoras personalizadas para vídeos e projetos multimídia.
            </p>
          </div>
        </div>
      </section>
